...
<!--malaria-->
    ...
    <form method="post" action="">
        test<br>
        Positive<input type="radio" name="test" value="Positive" required <?php if(isset($edit)&&$edit['test']=='Positive')
        {echo 'checked';} ?>> <br>
        Negative<input type="radio" name="test" value="Negative" required<?php if(isset($edit)&&$edit['test']=='Negative')
        {echo 'checked';} ?>><br>
        Confirmation<br>
        Think film<br>
...
<!--serology-->
        ...
        HBsAg <input type="radio" name="HBsAg" value="Reactive" required
        ...
        Confirmation<br>
        s/co1<input type="text" name="s_list[]" required  <?php if(isset($edits)){echo "value=".$edits[0]; }?>><br>
        s/co2<input type="text" name="s_list[]" required <?php if(isset($edits)){echo "value=".$edits[1]; }?>><br>
        s/c03 <input type="text" name="s_list[]" required <?php if(isset($edits)){echo "value=".$edits[2]; }?>><br><br>
        Neutraliation<br>
        ...
        HCV Ab <input type="radio" name="HCVab" value="Reactive"  required
        ...
        Confirmation<br>
        s/co1<input type="text" name="s_list[]"  required<?php if(isset($edits)){echo "value=".$edits[3]; }?> ><br>
        s/co2<input type="text" name="s_list[]" required <?php if(isset($edits)){echo "value=".$edits[4]; }?>><br>
        s/c03 <input type="text" name="s_list[]"  required<?php if(isset($edits)){echo "value=".$edits[5]; }?>><br><br>
        LIA<br>
        ...
        HIV Ag/Ab <input type="radio" name="HIVag" value="Reactive" required
        ...
        Confirmation<br>
        s/co1<input type="text" name="s_list[]"  required <?php if(isset($edits)){echo "value=".$edits[6]; }?> ><br>
        s/co2<input type="text" name="s_list[]" required <?php if(isset($edits)){echo "value=".$edits[7]; }?>><br>
        s/c03 <input type="text" name="s_list[]" required <?php if(isset($edits)){echo "value=".$edits[8]; }?>><br><br>
        ...
        HTLV-1/11 <input type="radio" name="HTLV" value="Reactive" required
        ...
        Confirmation<br>
        s/co1<input type="text" name="s_list[]"  required <?php if(isset($edits)){echo "value=".$edits[9]; }?>><br>
        s/co2<input type="text" name="s_list[]" required <?php if(isset($edits)){echo "value=".$edits[10]; }?>><br>
        s/c03 <input type="text" name="s_list[]" required <?php if(isset($edits)){echo "value=".$edits[11]; }?>><br><br>
        LIA<br>
        ...
        syphilis <input type="radio" name="syphilis" value="Reactive" required
        ...
        <input type="radio" name="tb" value="1/1280"
         ...
         HBs Ab <input type="radio" name="HBs" value="0>10" required
            <?php if(isset($edit)&&$edit['HBs']=='0>10'){echo 'checked';} ?>> Non Reactive(0>10)<br>
        <input type="radio" name="HBs" value="Reactive"
            <?php if(isset($edit)&&$edit['HBs']=='Reactive'){echo 'checked';} ?>> Reactive<br>

        <input type="radio" name="HBs" value="10>100"
            <?php if(isset($edit)&&$edit['HBs']=='10>100'){echo 'checked';} ?>>10>100
        <input type="number" name="HBsText"<?php if(isset($edit['HBsText'])){echo 'value="'.$edit['HBsText'].'"';} ?>><br>




        <input type="radio" name="HBs" value=">1000"
            <?php if(isset($edit)&&$edit['HBs']=='>1000'){echo 'checked';} ?>>>1000<br><br>

        HBc <input type="radio" name="HBc" value="Reactive" required
