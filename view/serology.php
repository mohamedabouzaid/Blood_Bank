...
<div class="w3-bar w3-light-grey">
    ...
    if($units!= null)
    {
        ...
        foreach ($units as $unit) {
            ...
            echo "   <tr>
                                                <td>" . $unit['unitNo'] . "</td>
                                                 <td><a  class=\"w3-btn w3-gray\" href='serologyOpertation.php?do=insert& unit=" . $unit['unitNo'] . "'>Insert </a></td>
                                                  <td><a  class=\"w3-btn w3-gray\" href='serologyOpertation.php ?do=update& unit=" . $unit['unitNo'] . "'>update </a></td>
