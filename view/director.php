...
<div class="w3-bar w3-light-grey">
    ...
    if($units!= null)
    {
        ...
        foreach ($units as $unit) {
            ...
            echo "   <tr>
                                                <td>" . $unit['unitNo'] . "</td>
                                                 <td><a  class=\"w3-btn w3-gray\" href='directorOperation.php?do=insert& unit=" . $unit['unitNo'] . "'>check </a></td>
                                                 <td><a  class=\"w3-btn w3-gray\" href='directorOperation.php?do=update& unit=" . $unit['unitNo'] . "'>update </a></td>
