...
<div class="w3-bar w3-light-grey">
    <a href="bacterial.php" class="w3-bar-item w3-button">Immuno Department Home</a>     <!-- immuno Department home button -->
    <!--search form-->
    ...
    if($units!= null)
    {
        ...
        foreach ($units as $unit) {
            ...
            echo "   <tr>
                                                <td>" . $unit['unitNo'] . "</td>
                                                 <td><a  class=\"w3-btn w3-gray\" href='immunoOperation.php?do=insert& unit=" . $unit['unitNo'] . "'>Insert </a></td>
                                                  <td><a  class=\"w3-btn w3-gray\" href='immunoOperation.php?do=update& unit=" . $unit['unitNo'] . "'>update </a></td>
